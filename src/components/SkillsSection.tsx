...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['React.js', 'React Native', 'Tailwind CSS', 'Electron.js', 'TypeScript', 'Framer Motion'],
  ...
  },
  {
    ...
    items: ['Node.js', 'Express.js', 'Spring Boot', 'Docker', 'Redis', 'REST APIs'],
  ...
  },
  {
    ...
    badge: 'PERSISTENCE',
    items: ['MongoDB Atlas', 'PostgreSQL', 'MySQL', 'Prisma', 'Indexing'],
    description: 'Designing resilient relational and document schemas with optimized indexing, transactions, and tenant isolation.',
    stat: 'ACID & NOSQL',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'INTELLIGENCE',
    items: ['C++', 'Python', 'Java', 'scikit-learn', 'OpenAI API', 'NLP Pipelines'],
...
const BentoCard: React.FC<{ block: (typeof bentoCategories)[0] }> = ({ block }) => {
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3
        className="text-3xl sm:text-4xl font-normal tracking-wide text-white mb-3 group-hover:text-[#F7E7C4] transition-colors relative z-10"
      ...
      {/* Description */}
      <p
        className="text-xs sm:text-sm text-[#A8988B] font-light leading-relaxed mb-7 max-w-xl group-hover:text-[#D5CBC0] transition-colors relative z-10"
      ...
      <div className="flex flex-wrap gap-2 pt-4 border-t border-[#8C6D4F]/20 relative z-10">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          {bentoCategories.map((block) => (
            <BentoCard key={block.title} block={block} />
          ))}
        </motion.div>
